...
- 오프닝 훅 [0-9초]: 시청자의 관심을 끄는 강렬한 질문이나 문장
- 본문 [9-162초]: 사실 → 원인 → 구조 → 맥락 순서로 전개
- 인사이트 요약 [162-171초]: 핵심 내용을 한 문장으로 정리
- 마무리 [171-180초]: 반복 시청을 유도하는 멘트
- 자연스러운 구어체로 작성
- 시간 배분을 명시 (예: [0-9초], [9-162초], [162-171초], [171-180초])
